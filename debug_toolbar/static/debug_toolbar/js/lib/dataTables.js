...
!(function (n) {
    ...
    var p,
        ...
        w = function (t, v) {
            ...
            (v = t),
                ...
                (this.fnAdjustColumnSizing = function (t) {
                    const e = this.api(!0).columns.adjust(),
                        n = e.settings()[0],
                        a = n.oScroll;
                    t === N || t
                        ? e.draw(!1)
                    ...
                    if ("table" != this.nodeName.toLowerCase())
                        ...
                        for (
                            ...
                            if (
                                ...
                                const u = (r.bRetrieve !== N ? r : e).bRetrieve,
        ...
        $ = function (t) {
            if (!(t.length < 2))
                {for (
                    let e = t.slice().sort(), n = e[0], a = 1, r = e.length;
                    a < r;
                    a++
                ) {
                    if (e[a] === n) {return !1;}
        ...
        Y = function (t, e) {
            if (Array.isArray(e)) {for (let n = 0; n < e.length; n++) {Y(t, e[n]);}}
            else {t.push(e);}
            return t;
        };
    function i(n) {
        ...
        if (c)
            {for (; c; )
                {("TD" != (i = c.nodeName.toUpperCase()) && "TH" != i) ||
                    (o(c), u.push(c)),
                    (c = c.nextSibling);}}
        else {for (let p = 0, g = (u = e.anCells).length; p < g; p++) {o(u[p]);}}
    ...
    function v(t, e) {
        ...
        if (-1 !== P.inArray(!1, n)) {D(t, !1);}
            ...
            if (0 !== u.length)
                {for (
                    let f = s ? t.aoData.length : c, d = s ? 0 : n;
                    d < f;
                    d++
                ) {
                    var h,
    ...
    function _t(t) {
        for (
            ...
            if (((e = null), "<" == (n = d[h]))) {
                ...
                {for (let p = w.ext.feature, g = 0, b = p.length; g < b; g++)
                    {if (n == p[g].cFeature) {
                        e = p[g].fnInit(t);
                        break;
                    }}}
    ...
    function Ct(t, e, n) {
        ...
        for (let r = 0, o = n.length; r < o; r++)
            {for (let i = 0, l = n[r].length; i < l; i++)
                {!n[r][i].unique ||
                    (a[i] && t.bSortCellsTop) ||
                    (a[i] = n[r][i].cell);}}
        return a;
    ...
    function Tt(r, t, n) {
        function e(t) {
            let e = r.jqXHR ? r.jqXHR.status : null;
            ...
            u =
                    ...
                    delete l.data),
                {
                    ...
                    error: function (t, e, n) {
                        const a = R(r, null, "xhr", [r, null, r.jqXHR]);
                        -1 === P.inArray(!0, a) &&
                            ("parsererror" == e
    ...
    function It(t, n) {
        ...
        for (let l = 0, s = a.length; l < s; l++) {x(t, a[l]);}
        (t.aiDisplay = t.aiDisplayMaster.slice()),
            v(t, !0),
    ...
    function $t(a) {
        ...
        const c = P("<div><label/></div>").addClass(t.sLength);
        return (
    ...
    function pe(n, t, e) {
        ...
        if (t && t.time) {
            let l = R(n, "aoStateLoadParams", "stateLoadParams", [n, t]);
        ...
        t &&
            ...
            "ssp" == E(r)
                ...
                : (D(r, !0),
                  ...
                  Tt(r, [], function (t) {
                      pt(r);
                      for (let e = Ft(r, t), n = 0, a = e.length; n < a; n++)
                          {x(r, e[n]);}
                      u(r, o), D(r, !1);
                  }));
    }
    ...
    function Te(o, t, e, n) {
        function i(t, e) {
            ...
            if (Array.isArray(t) || t instanceof P)
                {for (let a = 0, r = t.length; a < r; a++) {i(t[a], e);}}
            else
    ...
    var Ie = [],
        ...
        B = function (t, e) {
            ...
            var o = [];
            if (Array.isArray(t))
                {for (let a = 0, r = t.length; a < r; a++) {n(t[a]);}}
            else {n(t);}
            (this.context = z(o)),
                e && P.merge(this, e),
        ...
        Fe =
            ...
            P.extend(B.prototype, {
                ...
                indexOf:
                    o.indexOf ||
                    function (t, e) {
                        for (let n = e || 0, a = this.length; n < a; n++)
            ...
            (B.register = e =
                function (t, e) {
                    if (Array.isArray(t))
                        ...
                        {for (
                            let r = t.split("."), o = Ie, i = 0, l = r.length;
                            i < l;
                            i++
                        ) {
                            var s,
        ...
        Le =
            ...
            t("rows().ids()", "row().id()", function (t) {
                for (
                    ...
                    {for (let o = 0, i = this[a].length; o < i; o++) {
                        const l = n[a].rowIdFn(n[a].aoData[this[a][o]]._aData);
                        e.push((!0 === t ? "#" : "") + l);
                    }}
                return new B(n, e);
            }),
            t("rows().remove()", "row().remove()", function () {
                ...
                return (
                    ...
                    this.iterator("table", function (t) {
                        for (let e = 0, n = t.aoData.length; e < n; e++)
                            {t.aoData[e].idx = e;}
                    }),
                    this
                );
            ...
            e("row.add()", function (e) {
                ...
                const t = this.iterator("table", function (t) {
                ...
                return (
                    ...
                    null === t || t === N
                        ? this.iterator("table", function (t) {
                              ...
                              let a, e, r, o, i, l, s, u, c, f, d, n, h, p;
                          })
                        : ((e = b
                              ? {
                                    page: b.page,
    ...
    if (Intl)
        {try {
            for (
                let qe = new Intl.NumberFormat().formatToParts(100000.1), n = 0;
                n < qe.length;
                n++
            )
                {"group" === qe[n].type
    ...
    function Ge(e) {
        return function () {
            const t = [ge(this[w.ext.iApiIndex])].concat(
